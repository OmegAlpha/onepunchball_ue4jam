...
AUEMakeItCountCharacter::AUEMakeItCountCharacter()
{
...
void AUEMakeItCountCharacter::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
...
void AUEMakeItCountCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AUEMakeItCountCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AUEMakeItCountCharacter::MoveRight);

}

void AUEMakeItCountCharacter::BeginPlay()
{
	Super::BeginPlay();
...
void AUEMakeItCountCharacter::Tick(float DeltaSeconds)
{
